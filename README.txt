...
v2.17: オンライン再戦を追加。同じPeer接続・同じ4桁ルームを維持したまま再戦可能。ホストが再戦時は即リセット、P2が押した場合はホストへrematch-requestを送り、ホストがHP/RP/AP/ターン等を初期化して両端末へ同期。

[v2.35]
- ダイスの全画面演出とダイス効果音を撤去。
- BGMをWebAudio生成式から audio/battle.mp3 のループ再生式へ変更。
- 音量は js/app.js の battleBgm.volume で調整。
